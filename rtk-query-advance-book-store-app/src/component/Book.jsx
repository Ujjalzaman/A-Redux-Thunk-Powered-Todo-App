...
const genStarIcon = (iconNumber) => {
    ...
    const star = <svg viewBox="0 0 20 20" fill="currentColor" className="lws-star">{path}</svg>;
    const iconNumbers = [...Array(iconNumber).keys()];
    return (
        <>
            {iconNumbers.map((_, index) => (
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-gray-500 space-x-2">
                        ...
                        <button disabled={isLoading} className="lws-delete" onClick={() => handleDelete(id)}>
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round"
